<script lang="ts">
  ...
  export let spellPreview: Spell | undefined;
</script>
...
<bar>
  ...
  {/each}
  <button class="end_turn material-symbols-rounded" on:click={() => dispatch('endturn')}> play_arrow </button>
</bar>
